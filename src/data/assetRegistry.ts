...
export const ASSET_REGISTRY: RegisteredAsset[] = [
  ...
  // ── CRYPTO-MONNAIES (Revolut X / Live Quotes) ──
  {
    ticker: 'BTC-EUR',
    ...
    exchange: 'Revolut X / Live Crypto',
    searchTerms: ['btc', 'bitcoin', 'btc-eur', 'btceur', 'crypto', 'revolut'],
  },
  {
    ticker: 'BTC-USD',
    ...
    themes: ['crypto', 'digital-gold'],
    exchange: 'Revolut X / Live Crypto',
    searchTerms: ['btc', 'bitcoin', 'btc-usd', 'btcusd', 'crypto'],
  },
  {
    ticker: 'ETH-EUR',
    ...
    exchange: 'Revolut X / Live Crypto',
    searchTerms: ['eth', 'ethereum', 'eth-eur', 'etheur', 'crypto', 'revolut'],
  },
  {
    ticker: 'ETH-USD',
    ...
    themes: ['crypto', 'smart-contracts'],
    exchange: 'Revolut X / Live Crypto',
    searchTerms: ['eth', 'ethereum', 'eth-usd', 'ethusd', 'crypto'],
  },
  {
    ticker: 'SOL-EUR',
    name: 'Solana (SOL / EUR)',
    ...
    envelope: 'CTO',
    currency: 'EUR',
    themes: ['crypto', 'layer1'],
    exchange: 'Revolut X / Live Crypto',
    searchTerms: ['sol', 'solana', 'sol-eur', 'soleur', 'crypto', 'revolut'],
  },
];
